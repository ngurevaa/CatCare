...
class VaccinationAddingBottomSheetFragment : BottomSheetDialogFragment(R.layout.fragment_adding_bottom_sheet) {
    private var binding: FragmentAddingBottomSheetBinding? = null

    private var petId: Int? = null

    private val viewModel: VaccinationAddingViewModel by lazyViewModel {
